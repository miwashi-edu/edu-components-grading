...
> To achieve the grade of yellow belt you need to complete this task in 8 minutes using only [`bash`](https://www.gnu.org/s/bash/manual/bash.html) and [`vim`](https://www.vim.org).
